    ...
    <div class="bg-white rounded-[2.5rem] shadow-lg overflow-hidden">
        ...
        <div class="bg-white px-8 lg:px-16 py-12">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-0 items-start">
                    
                    <!-- Columna 1: ORGANIZED BY -->
                    <div class="text-center relative">
                        <p class="text-[#08254f] font-bold text-sm mb-6 tracking-wider">ORGANIZED BY</p>
                    ...
                    <div class="text-center relative">
                        <p class="text-[#08254f] font-bold text-sm mb-6 tracking-wider">STRATEGIC SUPPORT</p>
                        <div class="flex justify-center">
        ...
        <div class="bg-[#08254f] px-8 lg:px-16 py-8">
